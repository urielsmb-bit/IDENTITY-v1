...
export const CAMPOS_PLANTILLA = [
  ...
  'animatedName', 'nameFx', 'fxInt', 'fxVel', 'glowName',
  'cursorTrailColor', 'cursorTrailInt', 'cursorTrailDir', 'glowSocials', 'glowBadges', 'noise', 'tilt',
  ...
  /* De que plantilla de arranque salio. Viaja porque quien la aplica se
     ...
     aspecto de una plantilla y el rotulo de otra. */
  'base',
