...
--
-- Migraciones 0002 a 0006, en orden, en un solo archivo.
-- Re-ejecutable: se puede lanzar entero aunque ya aplicaras parte.
--
-- Saldra el aviso de "operaciones destructivas": son los
-- `drop policy if exists`, `drop view` y `revoke`. No borra datos.
--
